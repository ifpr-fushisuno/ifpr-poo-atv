...
public class ProfissionalDAO {
	...
	public Profissional getProfissionalByCpf(String cpf) throws ExceptionDAO {
		String sql = "SELECT * FROM Pessoa p " + "JOIN Funcionario f ON p.idPessoa = f.idPessoa"
				+ "JOIN Profissional pp on f.idFuncionario = pp.idFuncionario WHERE p.cpf = ?";
		try (Connection conn = new ConexaoBD().getConnection(); PreparedStatement stmt = conn.prepareStatement(sql)) {
	...
	public Profissional getProfissionalByLogin(String username) throws ExceptionDAO, SQLException {
		String sql = "SELECT * FROM Pessoa p " + "JOIN Funcionario f ON p.idPessoa = f.idPessoa "
				+ "JOIN Profissional pp ON f.idFuncionario = pp.idFuncionario " + "WHERE f.login = ?";

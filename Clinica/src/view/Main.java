...
public class Main {
	public static void main(String[] args) throws Exception {
		...
		while (true) {
            ...
            System.out.println("6. Menu de Profissionais");
			...
			case 4:
				...
				while (true) {
					...
					case 1:
						...
						String cargo = scanner.nextLine();
						try {
							recepcionistaController.createFullRecepcionista(nome, telefone, rg, cpf, dataNascimento,
									sexo, profissao, endereco, login, senha, cargo);
						} catch (Exception e) {
							System.out.println("Erro: " + e.getMessage());
						}
						break;
					...
					case 3:
						...
						System.out.print("CPF da Recepcionista a ser excluída: ");
						cpf = scanner.nextLine();

						try {
							recepcionistaController.deleteRecepcionista(cpf);
					...
					case 4:
						...
						try {
							Recepcionista recepcionista = recepcionistaController
									.getRecepcionistaByCpf(cpfBuscarRecepcionista);
			...
			case 5:
				...
				while (true) {
					...
					case 1:
						...
						try {
							gerenteController.createFullGerente(nomeGerente, telefoneGerente, rgGerente, cpfGerente,
									dataNascimentoGerente, sexoGerente, profissaoGerente, enderecoGerente, loginGerente,
									senhaGerente, cargoGerente);
					...
					case 2:
						...
						System.out.print("CPF do Gerente a ser atualizado: ");
						cpfGerente = scanner.nextLine();
						Gerente gerenteAt = gerenteController.getGerenteByCpf(cpfGerente);
						if (gerenteAt != null) {
							System.out.print("Nome: ");
							nomeGerente = scanner.nextLine();
							System.out.print("Telefone: ");
							telefoneGerente = scanner.nextLine();
							System.out.print("RG: ");
							rgGerente = scanner.nextLine();
							System.out.print("CPF: ");
							cpfGerente = scanner.nextLine();
							System.out.print("Data de Nascimento (YYYY-MM-DD): ");
							dataNascimentoInputGerente = scanner.nextLine();
							dataNascimentoGerente = Date.valueOf(dataNascimentoInputGerente);
							System.out.print("Sexo: ");
							sexoGerente = scanner.nextLine();
							System.out.print("Profissão: ");
							profissaoGerente = scanner.nextLine();
							System.out.print("Endereço: ");
							enderecoGerente = scanner.nextLine();
							System.out.print("Login: ");
							loginGerente = scanner.nextLine();
							System.out.print("Senha: ");
							senhaGerente = scanner.nextLine();
							System.out.print("Cargo: ");
							cargoGerente = scanner.nextLine();

							try {
								gerenteController.updateGerente(nomeGerente, telefoneGerente, rgGerente, cpfGerente,
										dataNascimentoGerente, sexoGerente, profissaoGerente, enderecoGerente,
										loginGerente, senhaGerente, cargoGerente);
					...
					case 3:
						...
						System.out.print("CPF do Gerente a ser excluído: ");
						String cpf = scanner.nextLine();

						try {
							gerenteController.deleteGerente(cpf);
            ...
            case 6:
                ...
                while (true) {
                    ...
                    System.out.println("4. Buscar Profissional por Registro de Conselho");
                    System.out.println("5. Buscar Profissional por CPF");
                    System.out.println("6. Sair");
                    System.out.print("Escolha uma opção: ");

                    int profissionalOption = scanner.nextInt();
                    scanner.nextLine();

                    switch (profissionalOption) {
                    case 1:
                        ...
                        System.out.print("Registro de Conselho: ");
                        String registroConselho = scanner.nextLine();
                        System.out.print("Data de Inscrição (YYYY-MM-DD): ");
                        String dataInscricaoInput = scanner.nextLine();
                        Date dataInscricao = Date.valueOf(dataInscricaoInput);

                        try {
                            profissionalController.createFullProfissional(nome, telefone, rg, cpf, dataNascimento, sexo, profissao, endereco, login, senha, cargo, especialidade, registroConselho, dataInscricao);
                    ...
                    case 2:
                        ...
                        System.out.print("Registro de Conselho do Profissional a ser atualizado: ");
                        String registroParaAtualizar = scanner.nextLine();
                        Profissional profissionalAtual = profissionalController.getProfissionalByRegistro(registroParaAtualizar);
                        if (profissionalAtual != null) {
                            ...
                            System.out.print("Registro de Conselho: ");
                            registroConselho = scanner.nextLine();
                            System.out.print("Data de Inscrição (YYYY-MM-DD): ");
                            dataInscricaoInput = scanner.nextLine();
                            dataInscricao = Date.valueOf(dataInscricaoInput);

                            try {
                                profissionalController.updateProfissional(nome, telefone, rg, cpf, dataNascimento, sexo, profissao, endereco, login, senha, cargo, especialidade, registroConselho, dataInscricao);
                    ...
                    case 3:
                        ...
                        System.out.print("CPF do Profissional a ser excluído: ");
                        cpf = scanner.nextLine();

                        try {
                            Profissional profissionalExcluir = profissionalController.getProfissionalByCpf(cpf);
                            if(profissionalExcluir != null) {
                                profissionalController.deleteProfissional(cpf);
                    ...
                    case 4:
                        // Buscar Profissional por Registro de Conselho
                        System.out.println("=== Buscar Profissional por Registro de Conselho ===");
                        System.out.print("Registro de Conselho do Profissional a ser buscado: ");
                        String registroBuscar = scanner.nextLine();

                        try {
                            Profissional profissionalBuscado = profissionalController.getProfissionalByRegistro(registroBuscar);
                            if (profissionalBuscado != null) {
                                System.out.println("Profissional encontrado: " + profissionalBuscado.getNome());
                            } else {
                                System.out.println("Profissional não encontrado.");
                            }
                        } catch (Exception e) {
                    ...
                    case 5:
                        ...
                        System.out.println("=== Buscar Profissional por CPF ===");
                        System.out.print("CPF do Profissional a ser buscado: ");
                        String cpfBuscarProfissional = scanner.nextLine();

                        try {
                            Profissional profissionalCpfBuscado = profissionalController.getProfissionalByCpf(cpfBuscarProfissional);
                            if (profissionalCpfBuscado != null) {
                                System.out.println("Profissional encontrado: " + profissionalCpfBuscado.getNome());
                            } else {
                                System.out.println("Profissional não encontrado.");
                            }
                        } catch (Exception e) {
                    ...
                    System.out.println();
                    if (profissionalOption == 6) {
                        break; // sair do menu de profissionais
                    }
                }
                break;
